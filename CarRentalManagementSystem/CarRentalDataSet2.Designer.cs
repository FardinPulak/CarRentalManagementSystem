...
namespace CarRentalManagementSystem.CarRentalDataSet2TableAdapters {
...
SELECT ID, Name, [Date Of Birth], Gender, Phone, Mail, Post, Salary, Password, [Joining Date] FROM UserID WHERE (ID = @ID)";
        ...
        public virtual int Fill(CarRentalDataSet2.UserIDDataTable dataTable) {
        ...
        public virtual CarRentalDataSet2.UserIDDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CarRentalDataSet2.UserIDDataTable dataTable = new CarRentalDataSet2.UserIDDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CarRentalDataSet2.UserIDDataTable dataTable) {
