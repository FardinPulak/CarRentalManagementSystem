...
SELECT ID, Name, [Date Of Birth], Gender, Phone, Mail, Post, Salary, Password, [Joining Date] FROM UserID WHERE (ID = @ID)";
        ...
        public virtual int Fill(CarRentalDataSet.UserIDDataTable dataTable) {
        ...
        public virtual CarRentalDataSet.UserIDDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CarRentalDataSet.UserIDDataTable dataTable = new CarRentalDataSet.UserIDDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CarRentalDataSet.UserIDDataTable dataTable) {
